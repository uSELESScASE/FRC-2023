...
public class Drivetrain {
  ...
  public PWMSparkMax m_R_Top;
  public PWMSparkMax m_R_Bot;
  public PWMSparkMax m_L_Top;
  public PWMSparkMax m_L_Bot;
...
public void sensitiveArcadeDrv(double spd, double rot){
  spd *= Constants.throttleMult;
  rot *= Constants.throttleMult;
  m_robotDrive.arcadeDrive(spd, rot);
